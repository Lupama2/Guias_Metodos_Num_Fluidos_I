...
\begin{figure}[h]
  \includegraphics[clip=true,width=0.5\columnwidth]{simple_esquema.png}
...
\begin{figure}[h]
  \includegraphics[clip=true,width=0.5\columnwidth]{doble_esquema.png}
...
\end{figure}
La extraje del pdf Double Pendumlum de la página de la materia
