...
\begin{table}[]
  ...
  \cellcolor[HTML]{EFEFEF} & \multicolumn{6}{c|}{\cellcolor[HTML]{EFEFEF}Orden de convergencia de} \\ \cline{2-7} 
  \rowcolor[HTML]{C0C0C0} 
  \cellcolor[HTML]{EFEFEF} & \multicolumn{3}{c|}{\cellcolor[HTML]{C0C0C0}$e_{fase}$} & \multicolumn{3}{c|}{\cellcolor[HTML]{C0C0C0}$e_{amp}$} \\ \cline{2-7} 
  \rowcolor[HTML]{C0C0C0} 
  \multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}Método} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}teórico} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}con $\theta_0 = \pi/2$} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}con $\theta_0 = 0.01$} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}teórico} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}con $\theta_0 = \pi/2$} & \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}con $\theta_0 = 0.01$} \\ \hline
  \cellcolor[HTML]{C0C0C0}EI & \multicolumn{1}{l|}{2} & \multicolumn{1}{l|}{$0.91 \pm 0.03$} & \multicolumn{1}{l|}{$1.97 \pm 0.03$} & \multicolumn{1}{l|}{1} & \multicolumn{1}{l|}{$0.94 \pm 0.02$} & $0.91 \pm 0.03$ \\ \hline
  \cellcolor[HTML]{C0C0C0}CN & \multicolumn{1}{l|}{2} & \multicolumn{1}{l|}{$1.96 \pm 0.02$} & \multicolumn{1}{l|}{$1.93 \pm 0.04$} & \multicolumn{1}{l|}{0} & \multicolumn{1}{l|}{$5.79 \pm 0.09$} & $4.94 \pm 0.03$ \\ \hline
  \cellcolor[HTML]{C0C0C0}RK4 & \multicolumn{1}{l|}{4} & \multicolumn{1}{l|}{$3.92 \pm 0.02$} & \multicolumn{1}{l|}{$4.02 \pm 0.02$} & \multicolumn{1}{l|}{5} & \multicolumn{1}{l|}{$4.87 \pm 0.04$} & $3.010 +/- 0.005$ \\ \hline
  \cellcolor[HTML]{C0C0C0}CN + LF & \multicolumn{1}{l|}{3} & \multicolumn{1}{l|}{$1.86 \pm 0.05$} & \multicolumn{1}{l|}{$1.96 \pm 0.02$} & \multicolumn{1}{l|}{0} & \multicolumn{1}{l|}{\$2.96 \textbackslash{}pm 0.05\%} & 0 \\ \hline
  \end{tabular}
\end{table}

\textcolor{red}{Quizás convenga juntar la tabla y las figuras de los errores en una sola página.}
