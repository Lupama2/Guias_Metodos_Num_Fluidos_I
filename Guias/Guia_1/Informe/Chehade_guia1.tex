...
Se analizaron cualitativamente ambas aproximaciones para $K$ y $N$ fijos. En la figura \ref{fig:comportamiento_cuali} se grafica la solución exacta junto a las soluciones aproximadas en puntos discretos por ambos métodos.
